...
export const fetchDirectoryChildrenData = [{ name: '.sh_history', type: 'file', size: 1276 },
...
export const fetchDirectoryChildrenDataResponse = {
    children: fetchDirectoryChildrenData,
};

export const fetchDirectoryChildrenRootData = [
...
export const fetchDirectoryChildrenRootDataResponse = {
    children: fetchDirectoryChildrenRootData,
};
